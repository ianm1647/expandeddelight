...
public class CuttingRecipes {
    ...
    private static void cuttingFoods(RecipeOutput output) {
        CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.of(EDItems.CRANBERRY_COBBLER.get()), Ingredient.of(CommonTags.Items.TOOLS_KNIFE), EDItems.CRANBERRY_COBBLER_SLICE.get(), 4).save(output);
        CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.of(EDItems.HONEYED_GOAT_CHEESE_TART.get()), Ingredient.of(CommonTags.Items.TOOLS_KNIFE), EDItems.HONEYED_GOAT_CHEESE_TART_SLICE.get(), 4).save(output);

    }

    private static void cuttingFlowers(RecipeOutput output) {
        CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.of(EDItems.WILD_ASPARAGUS.get()), Ingredient.of(CommonTags.Items.TOOLS_KNIFE), EDItems.ASPARAGUS.get(), 1)
                .addResultWithChance(EDItems.ASPARAGUS_SEEDS.get(), 0.5F).addResultWithChance(Items.BROWN_DYE, 0.1F, 2).save(output);
        CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.of(EDItems.WILD_SWEET_POTATO.get()), Ingredient.of(CommonTags.Items.TOOLS_KNIFE), EDItems.SWEET_POTATO.get(), 1)
                .addResultWithChance(Items.GREEN_DYE, 0.1F, 2).save(output);
        CuttingBoardRecipeBuilder.cuttingRecipe(Ingredient.of(EDItems.WILD_CHILI_PEPPER.get()), Ingredient.of(CommonTags.Items.TOOLS_KNIFE), EDItems.CHILI_PEPPER.get(), 1)
