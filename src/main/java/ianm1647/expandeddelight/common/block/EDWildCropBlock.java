...
public class EDWildCropBlock extends FlowerBlock implements BonemealableBlock {
    protected static final VoxelShape SHAPE = Block.box(2.0, 0.0, 2.0, 14.0, 13.0, 14.0);

    public EDWildCropBlock(Holder<MobEffect> suspiciousStewEffect, int effectDuration, BlockBehaviour.Properties properties) {
        super(suspiciousStewEffect, (float)effectDuration, properties);
        FlammableBlockRegistry.getDefaultInstance().add(this, this.getFlammability((BlockState)null, (BlockGetter)null, (BlockPos)null, (Direction)null), this.getFireSpreadSpeed((BlockState)null, (BlockGetter)null, (BlockPos)null, (Direction)null));
    }
