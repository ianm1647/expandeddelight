...
public class BlockList {
    ...
    public static Block BROCCOLI_CRATE;
    public static Block ZUCCHINI_CRATE;
    public static Block BELL_PEPPER_CRATE;

    //crops
    public static Block ASPARAGUS_CROP = BlockRegistry.ASPARAGUS_CROP;
    public static Block SWEET_POTATO_CROP;
    public static Block BROCCOLI_CROP;
    public static Block ZUCCHINI_CROP;
    public static Block BELL_PEPPER_CROP;
    public static Block PEANUT_CROP = BlockRegistry.PEANUT_CROP;

    public static Block WILD_ASPARAGUS;
    public static Block WILD_SWEET_POTATO;
    public static Block WILD_BROCCOLI;
    public static Block WILD_ZUCCHINI;
    public static Block WILD_BELL_PEPPER;
